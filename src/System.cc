...
namespace ORB_SLAM2
{
    ...
    float resolution = fsSettings["PointCloudMapping.Resolution"];
        ...
        mpTcwDataCache = new DataCache<cv::Mat>();
        mpTcwDataCache->ExpandDataCacheSize(miDataCacheIndex);
...
*/
	...
	shared_ptr<PointCloudMapping> System::GetPointCloudMapping()
	{
	...
	if(!Tcw.empty())
	{
        mpTcwDataCache->InsertDataByIndex(Tcw, miDataCacheIndex);
    }
	return Tcw;
	}
    ...
    DataCache<cv::Mat>* System::GetTcwDataCache()
    {
        return mpTcwDataCache;
    }

    int32_t System::GetTcwDataCacheIndex()
    {
